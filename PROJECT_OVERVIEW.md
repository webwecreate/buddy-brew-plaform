...
- **แท็บสมาชิก** (default) — โปรไฟล์ + Tier badge (แตะเปิดหน้า Tier benefits) + **ไอคอน QR เล็กมุมบนขวา** (minimal, สำรองไว้ใช้ในอนาคต ไม่ใช่ flow หลักในการเก็บแต้มแล้ว เพราะตอนนี้ลูกค้าสแกนพนักงานแทน) + แต้มสะสม/progress bar + Badge (โชว์ 3 ที่ปลดแล้ว + ปุ่ม "ดูทั้งหมด") + **ประวัติการได้แต้ม (โชว์ 3 รายการล่าสุด + ปุ่ม "ดูทั้งหมด" เปิดหน้าแยกดูครบ)** + คูปอง + แบนเนอร์ชวนกรอกวันเกิด
